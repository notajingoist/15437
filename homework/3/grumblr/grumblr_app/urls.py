...
urlpatterns = patterns('',
    ...
    url(r'^search-stream$', 'grumblr_app.views.search_stream'),
    url(r'^search-home$', 'grumblr_app.views.search_home'),
    url(r'^search-profile/(?P<user_id>\d+)$', 'grumblr_app.views.search_profile'),
    # url(r'^profile$', 'grumblr_app.views.profile'),
    url(r'^profile/(?P<user_id>\d+)$', 'grumblr_app.views.profile'),
    url(r'^edit-profile$', 'grumblr_app.views.edit_profile'),
    url(r'^save-profile-changes$', 'grumblr_app.views.save_profile_changes'),
